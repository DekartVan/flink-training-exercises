...
public class HourlyTipsExercise extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple3<Long, Long, Float>> hourlyTips = fares.keyBy((TaxiFare fare) -> fare.driverId).timeWindow(Time.hours(1)).process(new CalculateTips());
...
// execute the transformation pipeline
	...
	public static class CalculateTips extends ProcessWindowFunction<TaxiFare, Tuple3<Long, Long, Float>, Long, TimeWindow> {
		@Override
